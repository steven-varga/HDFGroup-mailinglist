...
namespace h5 {
    struct pt_t {
        ...
        template<class T> inline typename std::enable_if<meta::is_scalar<T>::value,
        void>::type append( const T* ptr );
        template<class T> inline typename std::enable_if<meta::is_scalar<T>::value && !std::is_pointer<T>::value,
...
template<class T> inline typename std::enable_if< h5::meta::is_scalar<T>::value,
...
template<class T> inline typename std::enable_if<h5::meta::is_scalar<T>::value && !std::is_pointer<T>::value,
