...
namespace h5::meta {
    ...
    template <typename T> using container_type_f = typename T::container_type;
    template <typename T> using container_f = decltype(std::declval<T>().C);
    ...
    template <typename T> using emplace_back_f = decltype(std::declval<T>().emplace_back());
    template <typename T> using emplace_front_f = decltype(std::declval<T>().emplace_front());
    template <typename T> using emplace_f = decltype(std::declval<T>().emplace());
    ...
    template <typename T> using has_container_type = compat::is_detected<container_type_f, T>;
    template <typename T> using has_container = compat::is_detected<container_f, T>;
    ...
    template <typename T> using has_emplace_back = compat::is_detected<emplace_back_f, T>;
    template <typename T> using has_emplace_front = compat::is_detected<emplace_front_f, T>;
    template <typename T> using has_emplace = compat::is_detected<emplace_f, T>;
